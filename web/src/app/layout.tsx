...
import { ThemeProviderWrapper } from "~/components/task-pilot/theme-provider-wrapper";
import { env } from "~/env";

import { Toaster } from "../components/task-pilot/toaster";

export const metadata: Metadata = {
  title: "TaskPilot",
  description:
    "A multi-agent runtime that combines language models with specialized tools for research and complex task execution.",
