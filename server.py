...
"""
Server script for running the TaskPilot API.
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the TaskPilot API server")
    parser.add_argument(
        "--reload",
        action="store_true",
    ...
    try:
        logger.info(f"Starting TaskPilot API server on {args.host}:{args.port}")
