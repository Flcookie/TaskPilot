# GitHub Copilot Instructions for TaskPilot

This file provides guidance to GitHub Copilot when working with the TaskPilot repository.

## Project Overview

**TaskPilot** is a multi-agent runtime for complex research and task execution, built on LangGraph. It orchestrates AI agents to conduct research, generate reports, and create content like podcasts and presentations.
