...
This document explains how to manage license headers in the TaskPilot project.
...
LICENSE_HEADERS: Dict[str, str] = {
    "python": """# Copyright (c) 2025 TaskPilot contributors
# SPDX-License-Identifier: MIT
""",
    "typescript": """// Copyright (c) 2025 TaskPilot contributors
// SPDX-License-Identifier: MIT
""",
}
```
...
LICENSE_HEADERS = {
    # ... existing headers ...
    "javascript": """// Copyright (c) 2025 TaskPilot contributors
// SPDX-License-Identifier: MIT
""",
...
Header already present: web/src/components/task-pilot/logo.tsx
Header already present: web/src/components/task-pilot/markdown.tsx
