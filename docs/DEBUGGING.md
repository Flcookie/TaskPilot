...
This guide helps you debug TaskPilot workflows, view model outputs, and troubleshoot common issues.
...
TaskPilot uses Python's standard logging levels:
...
LANGSMITH_PROJECT="taskpilot-debug"
```
...
```
[INFO] System Prompt:
You are TaskPilot, a friendly AI assistant...
```
